...
def extract_files():
    ...
    move_file已经根据split安置数据集到train test了
    ...
    Extracting can be done with ffmpeg: 直接call 命令行
    `ffmpeg -i video.mpg image-%04d.jpg`
    -i input file; video.mpg
    image-%04d.jpg output file
    """
    data_file = []
    folders = ['train', 'test']
        ...
        for vid_class in class_folders:
            ...
            for video_path in class_files:
                ...
                if not check_already_extracted(video_parts):
                    # Now extract frames from a video.
